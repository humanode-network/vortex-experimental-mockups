...
export function PlanStep(props: {
  ...
  const { attemptedNext, draft, setDraft, textareaClassName } = props;
            ...
            >
              ...
              <Button
                ...
                onClick={() =>
                  setDraft((prev) => ({
                    ...prev,
                    timeline: prev.timeline.filter((item) => item.id !== ms.id),
                  }))
                }
              >
                Remove
            ...
            >
              ...
              <Button
                ...
                onClick={() =>
                  setDraft((prev) => ({
                    ...prev,
                    outputs: prev.outputs.filter((item) => item.id !== out.id),
                  }))
                }
              >
                Remove
